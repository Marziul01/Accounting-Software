...
class DetailedFinancialStatement extends Controller
{
    public function detailedFinancialStatement(Request $request)
    {
        ...
        return view('admin.accounts.detailedFinancialStatement',[
            ...
            'allFixedAssets' => $allFixedAssets,
            'allCurrentAssets' => $allCurrentAssets,
            'allShortLiabilities' => $allShortLiabilities,
            'allLongLiabilities' => $allLongLiabilities,
