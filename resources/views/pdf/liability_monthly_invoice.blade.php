...
@php
        ...
        $startDate = $liability->transactions->min('transaction_date');
        $endDate = $liability->transactions->max('transaction_date');
            ...
            <table class="table table-bordered mb-4">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>#{{ $liability->slug }}{{ $liability->id }}</td>
                        <td><strong>মোট গৃহীত ঋণের পরিমান</strong></td>
                        <td>{!! bn_number(number_format($depositInRange, 2)) !!}</td>
                    </tr>
                    <tr>
                        <td><strong>হিসাবের ধরন</strong></td>
                        <td>ঋণ প্রদান</td>
                        <td><strong>মোট পরিশোধিত ঋণের পরিমান</strong></td>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-bordered m-0">
                            ...
                            <tbody>
                                @php
                                    $depositTransactions = $liability->transactions
                                        ->where('transaction_type', 'Deposit')
                                        ->values();
                                    $withdrawTransactions = $liability->transactions
