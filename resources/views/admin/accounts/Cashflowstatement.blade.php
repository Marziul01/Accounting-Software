                ...
                <table class="w-full bg-white shadow-lg rounded-lg report-table border-collapse">
                    <thead>
                        <tr>
                            ...
                            <th class="w-1/6 text-center">প্রাপ্তি</th>
                            <th class="w-2/6 text-center">বিবরণ</th>
                            <th class="w-1/6 text-center">প্রদান</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" class="bg-gray-100 font-semibold text-center">আয় সমূহ:</td>
                            <td colspan="2" class="bg-gray-100 font-semibold text-center">ব্যয় সমূহ:</td>
                        </tr>
                        <tr>
                        ...
                        <tr class="bg-gray-100">
                            ...
                            @php
                                $totalIncomes =
                                    ...
                                    $totalInvestWithdraw +
                                    $totalCurrentAssettWithdraw +
                                    $totalLiabilitytDeposit +
                                    $totalBankWithdraw;
                            @endphp
                        ...
                        <tr class="bg-gray-100">
                            <td class="font-semibold">
                                @if ($previousPeriod == 'lastMonth')
                                    গত মাসের
                                    @endif @if ($previousPeriod == 'lastYear')
                                        গত বছরের
                                    @endif প্রারম্ভিক স্থিতি
                            </td>
                ...
                <table class="w-full bg-white shadow-lg rounded-lg report-table border-collapse">
                    <thead>
                        <tr>
                            ...
                            <th class="w-1/3 md:w-1/4 rounded-tr-lg text-center">টাকার পরিমাণ</th>
                        </tr>
                    </thead>
