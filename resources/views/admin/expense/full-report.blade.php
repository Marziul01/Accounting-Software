    ...
    <div class="container-fluid my-4">
                                ...
                                <table class="table table-bordered m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="category-total">
                                            <td colspan="4" class="text-end fw-bold">উপ-বিভাগ মোট:</td>
        ...
        <div class="card mb-4">
            <div class="card-body bg-success text-white">
                <h5 class="mb-0 text-center"><strong>সর্বমোট ব্যয় : {!! bn_number(number_format($grandTotal, 2)) !!} টাকা</strong></h5>
            </div>
        </div>
        ...
        <div class="text-center mt-3 no-print">
            <button onclick="window.print()" class="btn btn-success">প্রিন্ট করুন</button>
        </div>
    </div>
