                                        ...
                                        <table class="table table-bordered m-0">
                                            ...
                                            <tbody>
                                                @foreach ($liabilities->where('subcategory_id', $subcategory->id) as $liability)
                                                    @php
                                                        $initialAmount =
                                                            $liability->allTransactions->first()->amount ?? 0;
                                                        ...
                                                        if (
                                                            ...
                                                            $liability->allTransactions->first()->transaction_date >=
                                                                $startDate
                                                        ) {
                                                            ...
                                                            $previousAmount =
                                                                $depositBeforeStart - $withdrawBeforeStart;
                                                        }
