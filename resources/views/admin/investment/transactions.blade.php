        ...
        <div class="card ">
            <div class="card-header d-flex justify-content-between align-items-center border-bottom-1">
                ...
                <button type="button" class="btn btn-primary {{ Auth::user()->access->investment == 1 ? 'disabled' : '' }}"
                    data-bs-toggle="modal" data-bs-target="#updateModal{{ $investment->id }}">Add New Transactions </button>
            </div>
                                        ...
                                        @if (isset($depositTransactions[$i]))
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    ...
                                                    <form
                                                        action="{{ route('investmenttransaction.destroy', $depositTransactions[$i]->id) }}"
                                        ...
                                        @if (isset($withdrawTransactions[$i]))
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    ...
                                                    <form
                                                        action="{{ route('investmenttransaction.destroy', $withdrawTransactions[$i]->id) }}"
                                                        method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <input type="hidden" name="investment_id"
                                        value="{{ $investmentTransaction->investment_id }}">
                                    <div class="col-12 mb-3">
                                        <label>Transation Type</label>
                                        <select name="transaction_type" id="" class="form-select">
                                    ...
                                    @php
                                        $currentTransaction = $bankTransaction->where('from_id', $investmentTransaction->id)->first();
                                    @endphp
