                    ...
                    <table class="table" id="myTable">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ \Carbon\Carbon::parse($record->date)->format('d M, Y') ?? 'N/A' }}</td> <!-- ✅ Income Date -->
                                </td>
                                <td>
                                            ...
                                            <div class="d-flex gap-1 cursor-pointer">
                                                @if ($record->category_id == '13')
                                                    ...
                                                    data-bs-target="#incomeModal{{ $record->id }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>

                                                    <form action="{{ route('investment-income.destroy', $record->id) }}" method="POST" class="d-inline">
                                                        @csrf
                                                ...
                                                @else
                                                    ...
                                                    <a class="btn btn-sm btn-outline-secondary {{ Auth::user()->access->investment == 1 ? 'disabled' : '' }}" href="#" data-bs-toggle="modal"
                                                    data-bs-target="#expenseModal{{ $record->id }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>

                                                    <form action="{{ route('investment-expense.destroy', $record->id) }}" method="POST" class="d-inline">
                                                        @csrf
                    ...
                    <form id="investmentIncomeUpdateForm{{ $record->id }}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="" name="amount" value="{{ $record->amount }}" required>
                            </div>
                            <div class="mb-3">
